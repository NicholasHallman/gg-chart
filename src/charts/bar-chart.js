...
import { Axis, Column, Chart as Base, Categories } from '../chartComponents.js';
...
export class BarChart extends Chart(
  [Base, Axis, Column, Categories], // Components
  [axisRenderSystem, xAxisCategoryRenderSystem, yAxisValuesRenderSystem, yAxisColumnPopulator, columnRenderSystem, updateYAxisColumnValuesSystem ] // Systems
  ) {
